  ...
  define([], function() {
    return {
      ...
      /*
      		  ...
      		  the scope refers to a private component scope
       */
      onForumLoaded: function($scope, $foundry, $filter) {
        ...
        $scope.users = foundry._models.User.all().filter(function(x) {
          return x.name;
        });
        ...
        $scope.get_image_path = function(id) {
          return foundry._plugins.document._documents[id].webContentLink;
        };
